...
var gradeChangeNew = function(index) {
    if (null == index) {
        ...
        //alert(lang)
        index = lang ? ('s' == lang ? 0 : ('t' == lang) ? 2 : 1) : 1;
    } else if (!index && index != 0) {
        var index = $(".choise select").get(1).selectedIndex;
    }
    switch (index) {
        case 0:
            cantonese.zh_tran('s');
            ...
            location.href = Cookie_img_new.changeLanguageHostUrl(location.href, 'zh');
