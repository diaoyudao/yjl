...
return [
    ...
    'ADMIN_ALIAS' => '/adminenglish',  // 本地根目录路径

    'ADMIN_WEB_NAME' => '雅居乐官网后台管理系统 - 英文版',  // 后台网站名称
    ...
    'UPLOAD_FILE_SAVE_PATH' => '/datas_en/file/',  // 公告附件上传地址子目录，目录可以不存在，系统会自动创建
    ...
    'UPLOAD_LARGE_FILE_SAVE_PATH' => '/datas_en/large_file/file/',  // 大文件上传地址子目录，目录可以不存在，系统会自动创建
    'UPLOAD_LARGE_FILE_TEMP_PATH' => '/datas_en/large_file/temp/',  // 大文件上传地址子目录，目录可以不存在，系统会自动创建
