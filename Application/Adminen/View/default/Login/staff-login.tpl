<extend name="./Application/Adminen/View/default/base/login.tpl"/>
<block name="login_name">{$web_name} - 后台登录</block>
<block name="body_main">
    <input type="hidden" id="TenantId" name="TenantId" value=""/>
    <div class="header">
        <div class="title" style="margin-left: 166px;">{$web_name} - 后台登录</div>
    </div>
        ...
        <div id="loginform" class="loginBox" style="padding-top:10px;">
            <form class="form form-horizontal" method="post" id="form-login">
                <div class="row cl">
                    ...
                    <div class="radio-box">
                        <input type="radio" value="2" name="system-lang" id="system-lang-zh" >
                        <label for="system-lang-zh" class="f-16 f-w">中文版</label>
                    </div>
                        <div class="radio-box">
                            <input type="radio" value="1" name="system-lang" id="system-lang-en" checked>
                            <label for="system-lang-en" class="f-16">英文版</label>
                        </div>
                    </div>
                </div>
                <div class="row cl">
                ...
                <div class="row cl">
                    <div class="formControls col-xs-8 col-xs-offset-3">
                        ...
                        <img id="verify_png" src="/adminenglish/verify/login/index" style="width:120px;height:40px;"/>
...
<block name="footer_js">
    <script type="text/javascript">
        var newVerify = function () {
            var url = '/adminenglish/verify/login/index?rand=' + Math.random();
        ...
        $(function(){
            ...
            $('#system-lang-zh').click(function(){
                window.location.replace('http://' + '{$Think.config.DOMAIN_CHINESE}' + '/1fd3ab97ee/login/staff/login');
            });
        });
    </script>
</block>
