...
<block name="page_name">角色管理</block>
<block name="body_main">
    <div class="page-container">
        <form class="form form-horizontal" action="" method="get">
            <div class="text-c">
                <span>角色名:&nbsp; &nbsp;</span><input type="text" name="name" id="name" placeholder="" value="{$Think.get.name}"
                                                     style="width:100px"
                                                     class="input-text">
        ...
        <div class="cl pd-5 bg-1 bk-gray mt-20"><span class="l"> <a href="javascript:;" onclick="datadel()"
                                                 ...
                                                 onclick="admin_role_add('添加角色','/adminenglish/role/manage/add','900')">
												 <img style="width:12px;height:12px;margin-top:-2px;" src="/public/img/iconfont/xe600-2.png" />
												 添加角色</a> </span> <span class="r">共有数据：<strong>{$counts}</strong> 条</span>
        </div>
                ...
                <tr class="text-c">
                    ...
                    <td class="f-14">
                        <a title="编辑" href="javascript:;"
                           onclick="admin_role_edit('角色编辑','/adminenglish/role/manage/change?id={$item.role_id}')"
    ...
    <script type="text/javascript">
        ...
        function admin_role_del(obj, id) {
            layer.confirm('角色删除须谨慎，确认要删除吗？', function (index) {
                ...
                K.doAjaxDeleteById(obj, param, '/adminenglish/role/manage/delete');
            });
        }
        /* 批量删除 */
        function datadel()
        {
            ...
            layer.confirm('角色删除须谨慎，确认要删除选中的角色吗？', function (index) {
                //此处请求后台程序，下方是成功后的前台处理……
                K.doAjax(param, '/adminenglish/role/manage/delete', function(response){
