...
//                    rangelength: [1, 100]
        ...
        function firmware_save1() {
            ...
            if (!$('#web-sitck').is(":hidden") && 1 == parameter.web_stick) {
                ...
                K.doAjax(param, "/adminenglish/templet/notice/webstick", function (req) {
                    if (0 < req.number) {
        ...
        function saveNotice1(parameter) {
            if ($('input[name=notice_id]').val()) {
                var url = '/adminenglish/templet/notice/changeone';
                parameter.notice_id = $('input[name=notice_id]').val();
            } else {
                var url = '/adminenglish/templet/notice/add';
            }
        ...
        function saveNotice(parameter) {
            if ($('input[name=notice_id]').val()) {
                var url = '/adminenglish/templet/notice/change';
                parameter.notice_id = $('input[name=notice_id]').val();
            } else {
                var url = '/adminenglish/templet/notice/add';
            }
