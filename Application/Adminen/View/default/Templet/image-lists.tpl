...
<block name="page_name"> > 图片管理</block>
    ...
    <div class="page-container">
        ...
        <div class="cl pd-5 bg-1 bk-gray mt-20"><span class="l"><a href="javascript:;" onclick="del_more()"
                    ...
                    批量删除</a> <a class="btn btn-primary radius" data-title="新增"
                                onclick="advert_add('新增','/adminenglish/templet/image/add')"
                ...
                <volist name="images" id="item">
                    <tr class="text-c">
                        ...
                        <td class="f-14 td-manage"><a style="text-decoration:none" class="ml-5"
                                                      onClick="advert_edit('编辑','/adminenglish/templet/image/change?image_id={$item.image_id}')"
    ...
    <script type="text/javascript">
        ...
        function advert_del(obj, id) {
            layer.confirm('确认要删除吗？', function (index) {
                ...
                K.doAjaxDeleteById(obj, param, '/adminenglish/templet/image/delete');
            });
        }
        ...
        function del_more() {
            ...
            layer.confirm('确认要删除选中的所有记录吗？', function (index) {
                K.doAjax(param, '/adminenglish/templet/image/delete', function (response) {
