...
//        var file_upload = upload_large_file.create('#big-file-list', '#big-file-picker', '#big-file-start', function (data) {
...
//        });
        ...
        function firmware_save() {
            ...
            if ($('input[name=video_id]').val()) {
                var url = '/adminenglish/templet/video/change';
            } else {
                var url = '/adminenglish/templet/video/add';
            }
