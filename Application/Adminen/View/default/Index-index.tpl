...
<head>
    ...
    <meta name="keywords" content="in-call后台管理系统模版">
    <meta name="description" content="changan in-call后台管理系统模版">
</head>
<body>
    ...
    <div class="navbar navbar-fixed-top">
        <div class="container-fluid cl">
            ...
            <nav id="Hui-userbar" class="nav navbar-nav navbar-userbar hidden-xs">
                <ul class="cl">
                    <li><select id="page-lang-change" style="height:24px;margin-top:10px;margin-right:10px;"><option value="chinese">中文版</option><option value="english" selected>英文版</option></select></li>
                    ...
                    <li class="dropDown dropDown_hover"><a href="#" class="dropDown_A">{$Think.session.staff_code}
                        ...
                        <ul class="dropDown-menu menu radius box-shadow">
                            <li><a _href="/adminenglish/staff/password/change" data-title="修改密码"
                                   onClick="Hui_admin_tab(this)">修改密码</a></li>
                            <li><a href="/adminenglish/login/staff/loginout">退出</a></li>
                        </ul>
                    </li>
                    <li id="Hui-msg"></li>
...
<aside class="Hui-aside">
    ...
    <div class="menu_dropdown bk_2">
        <php> foreach( $_SESSION['menu_privileges_en'] as $menu):</php>
        <dl id="menu-article">
...
<section class="Hui-article-box">
    ...
    <div id="iframe_box" class="Hui-article">
        <div class="show_iframe">
            ...
            <iframe scrolling="yes" frameborder="0" src="/adminenglish/login/welcome/index"></iframe>
        </div>
    </div>
</section>
...
<script type="text/javascript">
    $(function(){
        $('#page-lang-change').change(function() {
            ...
            if('chinese' == value) {
                parent.location.replace('http://' + '{$Think.config.DOMAIN_CHINESE}' + '/1fd3ab97ee');
                return;
            }
        });
    });
