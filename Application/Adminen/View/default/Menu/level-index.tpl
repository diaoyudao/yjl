                ...
                <form action="" method="post" class="form form-horizontal" id="form-change"
                    ...
                    <div class="row cl">
                        <div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-2">
                                 <button onClick="add_children_node('添加层级','/adminenglish/menu/level/add','700','700');"
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $("#form-change").validate({
                ...
                submitHandler: function (form) {
                    ...
                    try {
                        K.doAjaxSubmit('#form-change', '/adminenglish/menu/level/change');
                    } catch (e) {
                    }
                    return false; // 避免重复提交
                }
        ...
        function del_node() {
            ...
            layer.confirm('节点删除包含下属的所有节点，请谨慎，确认要删除吗？', function (index) {
                ...
                K.doAjax(param, '/adminenglish/menu/level/delete', function (response) {
