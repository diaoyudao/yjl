    ...
    <div class="section1">
        <div class="content container">
            <p><span><a href="/index">首页</a></span>&nbsp;&nbsp;&nbsp; > &nbsp;&nbsp;<span><a
                    href="/enter/index?level_id=1000000123">多元业务</a></span>&nbsp;&nbsp;
            ...
            <div class="box" style="margin-top: 50px;">
                <div class="waterfull clearfloat" id="waterfull">
                    <ul id="news-lists">
                        <li class="item">
                            <a href="/news/detail?id={$head_news[0].notice_id}" class="a-img" target='_blank'>
                            ...
                            <h4 class="li-title" title=""><a href="/news/detail?id={$head_news[0].notice_id}" target='_blank'>{$head_news[0].name}</a>
                            </h4>
                            <div class="description">{$head_news[0].desc}</div>
                            <div class="more"><a href="/news/detail?id={$head_news[0].notice_id}" target='_blank'>了解详情 <span class="icon"></span></a></div>
                        </li>
                        <volist name="notices" id="item">
                            <li class="item">
                                ...
                                <h4 class="li-title" title=""><a href="/news/detail?id={$item.notice_id}" target='_blank'>
                                    {$item.name}</a></h4>
...
//
                        ...
                        html += '<div class="more"><a href="/news/detail?id='+ res.head_news[0].notice_id +'" target="_blank">了解详情 <span class="icon"></span></a></div>';
