...
<block name="head_common1">
    <link rel="stylesheet" href="/public/css/home/business/business_hotel_list.css">
</block>
                ...
                K.doAjax(data, window.document.location.href, function (res) {
                    if (res.status && res.status == 'ok') {
                        ...
                        for (var i = 0; i < res.item.length; i++) {
                            var li = $("<li></li>");
                            var a = $("<a href='/business/hoteldetail?land_id="+res.item[i].land_id+"'></a>").appendTo(li);
                            ...
                            var more = $("<div class='more'>了解详情<span class='icon'></span></div>").appendTo(box)
                            li.appendTo(ul);
                        }
