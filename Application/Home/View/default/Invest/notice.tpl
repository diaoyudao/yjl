...
<block name="body_main">
                            ...
                            <ul >
                                ...
                                <a class="news" onclick="down_file('{$xx.url}')">
                                    下载
                                        ...
                                        <span class="time">{$xx.begin_time}</span>
                                    </li>
                                </volist>
                            </ul>
                        </div>
    ...
    <!--</ul>-->
    <!--<span class="prev"><img src="/public/img/home/invest/prev.png" alt=""></span>-->
    <!--<span class="next"><img src="/public/img/home/invest/next.png" alt=""></span>-->
    <!--</div>-->
...
//                                total = res.total;
//                                showNews(page);
//                                var content = $("<div class='box'><ul></ul><span class='prev'><img src='/public/img/home/common/btn_prev1.png' alt=''></span><span class='next'><img src='/public/img/home/common/btn_next1.png' alt=''></span></div>")
...
//                                    var a = $("<span  title='"+res.item[i][j].title+"'></span>").text(res.item[i][j].title.substring(0,40)).appendTo(li);
                                    ...
                                    var news = $("<a class='news' onclick='down_file(\"" + res.item[i][j].url + "\")' ></a>").text("下载").addClass("news").appendTo(li);
                                    var time = $("<span class='time'></span>").text(res.item[i][j].begin_time).appendTo(li);
