...
<block name="head_common1">
    <link rel="stylesheet" href="/public/css/mobile/business/easte_detail.css">
...
<block name="title">{$estate[0].name}-雅居乐集团</block>
...
<block name="body_main">
        ...
        <div class="box">
            <div class="container mt-10 mb-10">
                ...
                <div class="right" style="width: 60%">
                    ...
                    <p>售卖：
                        <if condition=" $estate[0]['is_sales'] eq 0">售罄
                            <else/>
                            在售
                        </if>
                    </p>
    ...
    <div class="mt-20 container pb-20">
        ...
        <div class="mt-20">
            <a href="/business/landmapsearch?x={$estate[0]['positon_x']}&y={$estate[0]['positon_y']}&name={$estate[0].name}">
                <img src="/public/img/mobile/business/easte/eastedetail/map-search.png" class="tags-img">
            </a>
        </div>
    </div>
    <div class="pt-20 pb-20 bgc-ef" id="sales">
        <h2 class="title-color main-title txt-center">热销楼盘</h2>
