...
<block name="body_main">
    ...
    <div class="content container">
        <p><span><a href="/index">首页</a></span>&nbsp;&nbsp;&nbsp; > &nbsp;&nbsp;<span><a
            ...
            > &nbsp;&nbsp;<a href="/business/life?level_id=1000000130"><span>雅生活</span></a>&nbsp;&nbsp;&nbsp;>&nbsp;&nbsp;&nbsp;<span>装饰</span>
        </p>
        <h2>公司介绍</h2>
        <div class="word">
    ...
    <div class="section2" style="text-align: center;overflow: hidden;padding-bottom: 100px;">
        ...
        <img src="/public/img/home/business/life/decorate/p1.jpg" alt="">
    </div>
        ...
        <ul>
            ...
            <li class="side-xin"><img src="/public/img/home/business/estate/detail/estate_icon4.png" alt="">
                <div class="xin-box">
                    ...
                    <img src="/public/img/home/business/decorate/two-code-decorate.jpg" alt="" width="130">
                </div>
            </li>
