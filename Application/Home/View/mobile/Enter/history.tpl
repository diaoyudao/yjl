...
<block name="head_common1">
    <link rel="stylesheet" href="/public/css/mobile/enter/history.css">
</block>
...
<block name="body_main">
    ...
    <div class="row cl body-main-bg pt-20 pb-20">
        <div class="container ">
            <div class="row cl txt-center mt-10"><span class="f-20 c-333 "><strong>发展历程</strong></span></div>
            <div class="row cl mt-20" id="list-history">
                <volist name="notice" id="item" offset="0" length='10'>
                    ...
                    <div class="row cl news-list"><a href="/enter/historydetail?year={$item[0].tags}">
            ...
            <div class="row cl main-btn mt-20" id="show_more">查看更多</div>    
        </div>
    </div>
                ...
                $('#show_more').click(function(){
                    ...
                    K.doAjax(data, window.document.location.href, function (res) {
                        ...
                        for (var i = 0; i < res.notice.length; i++) {
                            ...
                            + res.notice[i][0].name + '</div><a href="/enter/historydetail?year='+ res.notice[i][0].tags +'"><div class="news-more"></div></a></div></div></div> ';
