...
<block name="head_common1">
    <link rel="stylesheet" href="/public/css/mobile/enter/enter-videodetail.css">
</block>
...
<block name="title">{$media.title}-雅居乐集团</block>
 ...
 <block name="head_menu">
     <a class="tip" href="#">视频详情/</a>
 </block>

<block name="body_main">
  <div class="videoDetail container">
    <span class="min-title title-color">{$media.title}</span>
    <p class="mt-10" style="color:#818181">发布时间：<php> echo date('Y-m-d',strtotime($media['begin_time']))</php>  时长：{$media.duration}分钟  播放数:{$media['view_count']}
    <video  autoplay="autoplay" width="100%" height="240" class="mt-10" controls preload="auto" src="{$media.url}">
     ...
     <div class=" row cl container pt-20 mb-30 bg-c">
        <h2 class="txt-center">相关视频</h2>
            <volist name="medias" id="item" offset="0" length="2">
              <a href="/enter/publicityvediodetail?video_id={$medias[0].video_id}">
              ...
              <a href="/enter/publicityvediodetail?video_id={$medias[1].video_id}">
