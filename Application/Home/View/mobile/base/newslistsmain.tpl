<div class="option-content active">
          ...
          <a href="/news/detail?id={$item.notice_id}">
               <li>
                 <div class="box pt-20 pb-20">
                   <if condition=" 1 == $item['web_stick']"><img class="icon" src="/public/img/home/news/news-icon_03.png"></if>
      ...
      <a class="fff" id="much" onclick="show_more()"><div class="row cl mt-20 main-btn">查看更多</div></a>
