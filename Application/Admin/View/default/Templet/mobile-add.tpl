    ...
    <article class="page-container">
        <form class="form form-horizontal" id="form-advert-add" enctype="multipart/form-data">
            ...
            <div id="uploader" class="row cl">
                <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>简体图片(最大{$Think.config.UPLOAD_IMAGE_MAX_SIZE}M)：</label>
                <div class="formControls col-xs-8 col-sm-9">
                    <!--用来存放文件信息-->
                    ...
                    <div class="btns">
                        ...
                        <span class="tags-image-size-span ml-15 c-999" style="display: none;">建议尺寸：640*793</span>
                    </div>
                </div>
            </div>
            <div class="row cl">
            ...
            <div id="uploader" class="row cl">
                <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>繁体图片(最大{$Think.config.UPLOAD_IMAGE_MAX_SIZE}M)：</label>
                <div class="formControls col-xs-8 col-sm-9">
                    <!--用来存放文件信息-->
                    <div id="uploader-demo"></div>
                    <div class="btns">
            ...
            $("#form-advert-add").validate({
                ...
                submitHandler: function (form) {
                    ...
                    if ($('input[name=image_id]').val()) {
                        var url = '/1fd3ab97ee/templet/mobile/change';
                    } else {
                        var url = '/1fd3ab97ee/templet/mobile/add';
                    }
