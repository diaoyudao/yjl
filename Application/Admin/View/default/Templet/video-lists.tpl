        ...
        <div class="cl pd-5 bg-1 bk-gray mt-20">
            <span class="l">
                ...
                <a class="btn btn-primary radius" data-title="新增"
                   onclick="advert_add('新增','/1fd3ab97ee/templet/video/add')"
                    ...
                    <tr class="text-c">
                        ...
                        <td class="f-14 td-manage">
                            <a target="_blank" style="text-decoration:none" class="ml-5"
                               href="/1fd3ab97ee/templet/video/search?video_id={$item.video_id}"
                            ...
                            <a style="text-decoration:none" class="ml-5"
                               onClick="advert_edit(this,'编辑','/1fd3ab97ee/templet/video/change?video_id={$item.video_id}')"
    ...
    <script type="text/javascript">
        ...
        function advert_del(obj, id) {
            ...
            layer.confirm('确认要删除吗？', function (index) {
                ...
                K.doAjaxDeleteById(obj, param, '/1fd3ab97ee/templet/video/delete');
            });
        }
        ...
        function del_more() {
            ...
            layer.confirm('确认要删除选中的所有记录吗？', function (index) {
                K.doAjax(param, '/1fd3ab97ee/templet/video/delete', function (response) {
