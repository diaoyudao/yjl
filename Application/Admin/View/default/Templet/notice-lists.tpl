    ...
    <div class="page-container">
        ...
        <div class="cl pd-5 bg-1 bk-gray mt-20"><span class="l"><a href="javascript:;" onclick="del_more()"
               ...
               <a class="btn btn-primary radius" data-title="添加"
                  onclick="notice_add('添加', '/1fd3ab97ee/templet/notice/add')"
                ...
                <volist name="notices" id="item">
                    <tr class="text-c">
                        ...
                        <td><a style="cursor:pointer" class="text-primary"
                               onClick="notice_edit(this,'查看','/1fd3ab97ee/templet/notice/search?notice_id={$item.notice_id}')"
                        ...
                        <td class="f-14 td-manage">
                            <a target="_blank" style="text-decoration:none" class="ml-5"
                               href="/1fd3ab97ee/templet/notice/search?notice_id={$item.notice_id}"
                            ...
                            <a style="text-decoration:none" class="ml-5"
                               onClick="notice_edit(this,'编辑','/1fd3ab97ee/templet/notice/change?notice_id={$item.notice_id}')"
    ...
    <script type="text/javascript">
        ...
        function article_del(obj, id) {
            ...
            layer.confirm('确认要删除吗？', function (index) {
                ...
                K.doAjaxDeleteById(obj, param, '/1fd3ab97ee/templet/notice/delete');
            });
        }
        ...
        function del_more() {
            ...
            layer.confirm('确认要删除选中的所有吗？', function (index) {
                K.doAjax(param, '/1fd3ab97ee/templet/notice/delete', function (response) {
