...
<block name="body_main">
    <div class="page-container">
        ...
        <div class="cl pd-5 bg-1 bk-gray mt-20"><span class="l"><a href="javascript:;" onclick="del_more()"
                    ...
                    批量删除</a>
                 <include file="./Application/Admin/View/default/base/context/auditor-lists.tpl"/>
                <a class="btn btn-primary radius" data-title="添加"
                   onclick="notice_add('添加', '/1fd3ab97ee/business/hotel/add')"
                    ...
                    <tr class="text-c">
                        ...
                        <td class="f-14 td-manage">
                            <a target="_blank" style="text-decoration:none" class="ml-5"
                               href="/1fd3ab97ee/business/hotel/search?land_id={$item.land_id}"
                               title="预览"><i class="Hui-iconfont Hui-iconfont-yulan"></i></a>
                            <php>
                                $param="land_id=".$item['land_id'];
                            </php>
                            <include file="./Application/Admin/View/default/base/context/auditorone-lists.tpl"/>
                            <a style="text-decoration:none" class="ml-5"
                               onclick="manage_image(this,'{$item.name}-图片管理', '/1fd3ab97ee/business/image/lists?land_id={$item.land_id}&type=hotel');"
                               title="图片管理"><i class="Hui-iconfont">
                                    &#xe646;</i></a>
                            <a style="text-decoration:none" class="ml-5"
                               onclick="manage_image(this,'{$item.name}-mobile图片管理', '/1fd3ab97ee/business/mobile/lists?land_id={$item.land_id}&type=hotel');"
                               title="mobile图片管理"><i class="Hui-iconfont">
                                    &#xe696;</i></a>

                            <a style="text-decoration:none" class="ml-5"
                               onClick="notice_edit(this,'编辑','/1fd3ab97ee/business/hotel/change?land_id={$item.land_id}')"
    ...
    <script type="text/javascript">
        ...
        function article_del(obj, id) {
            ...
            layer.confirm('确认要删除吗？', function (index) {
                ...
                K.doAjaxDeleteById(obj, param, '/1fd3ab97ee/business/hotel/delete');
            });
        }
        ...
        function del_more() {
            ...
            layer.confirm('确认要删除选中的所有吗？', function (index) {
                K.doAjax(param, '/1fd3ab97ee/business/hotel/delete', function (response) {
