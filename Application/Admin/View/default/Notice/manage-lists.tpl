...
<block name="body_main">
    <div class="page-container">
        ...
        <div class="cl pd-5 bg-1 bk-gray mt-20"><span class="l"><a href="javascript:;" onclick="del_more()"
                                                 ...
                                                 onclick="notice_add('添加公告', '/1fd3ab97ee/notice/manage/add')"
                ...
                <volist name="notices" id="item">
                    <tr class="text-c">
                        ...
                        <td class="text-l"><a style="cursor:pointer" class="text-primary"
                                              onClick="notice_edit('公告查看','/1fd3ab97ee/notice/manage/search?notice_id={$item.notice_id}')"
                        ...
                        <td class="f-14 td-manage"><a style="text-decoration:none" class="ml-5"
                                                      onClick="notice_edit('公告编辑','/1fd3ab97ee/notice/manage/change?notice_id={$item.notice_id}')"
    ...
    <script type="text/javascript">
        ...
        function article_del(obj, id) {
            layer.confirm('确认要删除吗？', function (index) {
                ...
                K.doAjaxDeleteById(obj, param, '/1fd3ab97ee/notice/manage/delete');
            });
        }
        ...
        function del_more() {
            ...
            layer.confirm('确认要删除选中的所有公告吗？', function (index) {
                K.doAjax(param, '/1fd3ab97ee/notice/manage/delete', function (response) {
