            ...
            <div class="row cl ">
                <div class="col-xs-9 col-sm-10 col-xs-offset-3 col-sm-offset-2">
                    ...
                    <a target="_blank" style="text-decoration:none;display: none;" class="btn btn-primary radius hide"
                       id="search"
                       type="button"
                       href="/1fd3ab97ee/invest/credit/search"
                       title="预览">预览</a>&nbsp;&nbsp;
...
<block name="footer_js">
    <script type="text/javascript">
        function upFileClick() {
            ...
            K.sendForm('/1fd3ab97ee/invest/credit/import', formData, false, success, function (responseTxt) {
                //loadModel.hideModal();
                if (response.message) {
...
//                    parent.window.location.reload(parent.window.location.href);
        ...
        function changeStatus() {
            var url = '/1fd3ab97ee/invest/credit/changestatus';
            var data = {};
