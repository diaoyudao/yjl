...
<block name="body_main">
    <div class="page-container">
        ...
        <div class="cl pd-5 bg-1 bk-gray mt-20"><span class="l"> <a href="javascript:;" onclick="datadel()"
                                                 ...
                                                 onclick="admin_role_add('添加栏目组','/1fd3ab97ee/menu/authority/add','900')">
                ...
                <tr class="text-c">
                    ...
                    <td class="f-14">
                        <a title="编辑" href="javascript:;"
                           onclick="admin_role_edit('角色编辑','/1fd3ab97ee/menu/authority/change?id={$item.menu_authority_id}')"
    ...
    <script type="text/javascript">
        ...
        function admin_role_del(obj, id) {
            layer.confirm('栏目组删除须谨慎，确认要删除吗？', function (index) {
                ...
                K.doAjaxDeleteById(obj, param, '/1fd3ab97ee/menu/authority/delete');
            });
        }
        /* 批量删除 */
        function datadel()
        {
            ...
            layer.confirm('角色删除须谨慎，确认要删除选中的角色吗？', function (index) {
                //此处请求后台程序，下方是成功后的前台处理……
                K.doAjax(param, '/1fd3ab97ee/menu/authority/delete', function(response){
