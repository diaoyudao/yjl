        ...
        <form class="form form-horizontal" action="" name="searchform" method="get">
            <div class="text-c"> 日期范围：
                ...
                <input type="text" name="event" id="event" placeholder="操作内容" value="{$paramter.event}"
                       style="width:100px"
                       class="input-text">
                <input type="text" name="zh_en" id="zh_en" placeholder="中文版/英文版" value="{$paramter.zh_en}"
                       style="width:100px"
                       class="input-text">
                <button name="" id="" class="btn btn-success" onclick="check()" type="submit"><i class="Hui-iconfont">
                        &#xe665;</i> 搜索
                </button>
                <button name="" id="" class="btn btn-success" onclick="export_csv()" type="button"><i class="Hui-iconfont">
                        &#xe644;</i> 导出
                </button>
            </div>
        </form>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            var param = '&begin_date=' + '{$paramter.begin_date}' + '&end_date=' + '{$paramter.end_date}' +
                    ...
                    controller + '&action=' + action + '&event=' + event + '&zh_en=' + zh_en;
        ...
        function export_csv() {
            document.searchform.action="/1fd3ab97ee/system/log/export";
            document.searchform.submit();
            document.searchform.action="/1fd3ab97ee/system/log/lists";
        }
