...
<block name="body_main">
    ...
    <!-- Swiper -->
    <div class="row cl">
        <img class="img-responsive" src="/public_en/img/mobile/enter/header-enter.jpg" traditional_image="/public_en/img/mobile/enter/header-enter.jpg"
             simplified_image="/public_en/img/mobile/enter/header-enter.jpg" alt="">
        <div class="head-more">
            <a href="/en/enter/group?level_id=1000000126"><div class="main-btn">了解更多</div></a>
        </div>
    </div>
    <div class="container row cl mt-20 mb-20 pt-20 pb-20">
        <div class="mask-left">
            <div class="maskWraper" style=""> <img src="/public_en/img/mobile/enter/pic1.jpg" >
                <a href="/en/enter/chair?level_id=1000000127"><div class="maskBar text-c">陈卓林专区</div></a>
            </div>
        </div>
        <div class="mask-right">
            <div class="maskWraper" style=""> <img src="/public_en/img/mobile/enter/pic2.jpg" >
                <a href="/en/enter/duty?level_id=1000000138"><div class="maskBar text-c">社会责任</div></a>
            </div>
        </div>
    </div>
