...
<block name="head_common1">
    <link rel="stylesheet" href="/public_en/css/mobile/business/hotel_list.css">
...
<block name="head_menu">
    <a class="tip" href="#">Hotel Search/</a>
</block>
<block name="body_main">

    <div class="  container bgc-ef pt-20 pb-20">

        <h2 class="main-title title-color txt-center">Hotel Search</h2>

        <div class="search ">
            <div class="input mt-20 text-center ">
                <input type="text" placeholder="Please type the name of hotel" style="text-align: center;"><span class="butn txt-center">Search</span>
            </div>
        ...
        <div class="content">
            ...
            <a class="fff" id="much" onclick="show_more()">
                <div class="row cl mt-20 main-btn">More</div>
            </a>
