...
<block name="title">Property Development-Agile Group</block>

<block name="head_menu">
    <a class="tip" href="#">Property Development/</a>
</block>

<block name="body_main">
    <div class="content container bg-c">     
        <div class="row"><span class="main-title">Property Development</span></div>
