    ...
    <div id="bu-home" class="section1">
        ...
        <div class="banner" id="slider1">
                ...
                <div class="swiper-wrapper">
                    <volist name="head_images" id="item">
                        <div class="swiper-slide swiper-no-swiping">
                            <a  <if condition="$key EQ 0">href='/en/business/estatelists?level_id=1000000128'
                            <else />
            ...
            <div class="butn">
                <div class="btn1 btn-s">
                    <a href='/en/business/estatelists?level_id=1000000128' ><div class="mask"></div>
                ...
                <div class="btn2 btn-s">
                    <a href="/en/business/estatelists?level_id=1000000128&city_id=&type=Shops&is_sales=&keyword="><div class="mask"></div>
        ...
        <div class="search">
            <div class="container">
                ...
                <div class="input">
                    ...
                    <p>Sales Hotlines：400-020-3383</p>
                </div>
                <div class="side-list">
                    <ul>
                        <li class="side-tel">
            ...
            <div class="container">
                ...
                <div class="box">
                    ...
                    <div class="right">
                        ...
                        <span>in over 40 cities in China</span>
                        <p>
                        Agile has implementedits strategy of geographic diversificationin China and extended its presence into first overseas project in Kuala Lumpur. Agile has over 100 residential, commercial and tourism projects in differentstages of development.
                                    ...
                                    <div>
                                        ...
                                        <div class="word">
                                            ...
                                            <span class="name" style="z-index: 2">
                                                ...
                                                <a style="z-index: 2;color: #fff;" href="javascript:void(0);" class="aler">
                                                    {$item.name}</a></span><br>
                                        ...
                                        <div class="box">
                                            ...
                                            <br>
                                            <notempty name="item.tel">Sales hotline:<span class="phone">{$item.tel}</span></notempty><br>
        ...
        <div class="section3">
            <div class="content container">
                <a href="/en/business/estateexpresslists?level_id=1000000171"><span class="title">Projects Updates</span></a>
                <div class="news-box">
                        ...
                        <div class="items1">
                            ...
                            <!--<a href="/en/business/estateexpresslists?level_id=1000000171"
                               style="float: right;font-size: 16px;color: #9d7cb3;margin-top: 60px;">-->
                                <a  href="javascript:void(0);" class="aler" style="float: right;font-size: 16px;color: #9d7cb3;margin-top: 60px;">
