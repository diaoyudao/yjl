...
<block name="head_common1">
    <link rel="stylesheet" href="/public_en/css/home/business/business_home_list.css">
</block>
...
<block name="body_main">
    ...
    <div class="section2">
        <div class="content container">
            <p><span><a href="/en/index">Home</a></span>&nbsp;&nbsp;&nbsp; > &nbsp;&nbsp;<span><a href="/en/business/index?level_id=1000000125">Diversification of Business</a></span>&nbsp;&nbsp;
            ...
            <div class="search">
                <div class="box">
                    <div class="input">
                        <input type="text" placeholder="Please enter a project name or keyword" style="text-align: center;"><span class="btn">Search</span>
                    </div>
                    ...
                    <ul class="sales">
                        <li class="fir">Sales Status:</li>
                        <li><a id="">All</a></li>
                        <li><a id="1">Hot sale</a></li>
                        <li><a id="0">Sold</a></li>
                    </ul>
                </div>
            </div>
                    ...
                    <li>
                       <!-- <a href="/en/business/estatedetail?land_id={$item.land_id}">-->
                        <a  href="javascript:void(0);" class="aler">
                            ...
                            <div class="box">
                                <span>{$item.name}</span>
                                <p>Product Types: <php>echo str_replace(',',' ',$item['type'])</php></p>
                                <p>Sales Status:
                                ...
                                <p style="height: 42px;overflow: hidden;">Address: {$item.address}</p>
                ...
                K.doAjax(data, window.document.location.href, function (res) {
                    ...
                    if (res.status && res.status == 'ok') {
                        ...
                        for (var i = 0; i < res.item.length; i++) {
                            var li = $("<li></li>");
//                            var a = $("<a href='/en/business/estatedetail?land_id="+res.item[i].land_id+"'></a>").appendTo(li);
                            var a = $("<a  onclick='show_expecting()'></a>").appendTo(li);
                            ...
                            var status = $("<p></p>").text("Product Types: " + res.item[i].type.replace(/,/g,' ')).appendTo(box);
                            var sales;
                            (res.item[i].is_sales == 1) ? sales = "Hot sale" : sales = "Sold";
                            $("<p></p>").text("Sales Status: " + sales).appendTo(box)
                            var address = $("<p style='height:42px;overflow: hidden;'></p>").text("Address: " + res.item[i].address).appendTo(box);
                            if(res.item[i].tel)var phone = $("<p></p>").text("Sales hotline: " + res.item[i].tel).appendTo(box);
                            li.appendTo(ul);
                        }
