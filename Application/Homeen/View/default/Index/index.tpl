...
<block name="head_common1">
    <link rel="stylesheet" href="/public_en/css/home/index/index.css">
</block>
...
<block name="body_main">
    <div class="section1">
        ...
        <div class="tip">
            <p>We respect individual lifestyles.<br>
                By listening to our customers and understanding their needs, we strive to create a pleasant living environment and improve every details of life.<br>
              We build inner sanctums where the body unwinds and the soul recharged.
Such an attitude makes Agile stands out.</p>
        </div>
    </div>
    ...
    <div class="section2">
            ...
            <div class="butn">
                <div class="btn1 btn-s">
                    <a href="business/estate?level_id=1000000128">
                        <div class="mask"></div>
                        <span style="display:none"><img src="/public_en/img/home/business/estate/estate_btn1.png"
                                                        alt=""></span>
                        <div class="item" >
                            <span class="icon"><img src="/public_en/img/home/index/btn_icon1.png" alt=""></span>
                            <span class="tip">Property Development</span>
                        </div>
                    </a>
                </div>
                <div class="btn2 btn-s">
                    <a href="/en/business/hotel?level_id=1000000131">
                        <div class="mask"></div>
                        <span><img src="/public_en/img/home/business/estate/estate_btn5.png" alt=""></span>
                        <div class="item" style="display: none;">
                            <span class="icon"><img src="/public_en/img/home/index/btn_icon5.png" alt=""></span>
                            <span class="tip">Hotels Operations</span>
                        </div>
                    </a>
                </div>
                <div class="btn2 btn-s">
                    <a href="/en/business/education?level_id=1000000133">
                        <div class="mask"></div>
                        <span><img src="/public_en/img/home/business/estate/estate_btn3.png" alt=""></span>
                        <div class="item" style="display: none;">
                            <span class="icon"><img src="/public_en/img/home/index/btn_icon3.png" alt=""></span>
                ...
                <div class="btn2 btn-s">
                    <a href="/en/business/environment?level_id=1000000132">
                        <div class="mask"></div>
                        <span><img src="/public_en/img/home/business/estate/estate_btn4.png" alt=""></span>
                        <div class="item" style="display: none;">
                            <span class="icon"><img src="/public_en/img/home/index/btn_icon4.png" alt=""></span>
                            <span class="tip">Environmental Protection</span>
                        </div>
                    </a>
                </div>
                <div class="btn2 btn-s ">
                    <a href="/en/business/life?level_id=1000000130">
                        <div class="mask"></div>
                        <span><img src="/public_en/img/home/business/estate/estate_btn2.png" alt=""></span>
                        <div class="item" style="display: none;">
                            <span class="icon"><img src="/public_en/img/home/index/btn_icon2.png" alt=""></span>
                            <span class="tip">A-Living</span>
                        </div>
                    </a>
                </div>
            </div>
        ...
        <div class="news container">
            <h2><a onclick="show_expecting()" href="javascript:;">Group News</a></h2>
            <div class="content">
                <div class="left">
                ...
                <div class="word left">
                    <p class="title"><a style="float: none" onclick="show_expecting()" href="javascript:;">
                        {$group_notices[0].name}
                    </a>
                    </p>
                    <p>{$group_notices[0].desc}</p>
                </div>
                <div class="more"><a onclick="show_expecting()" href="javascript:;">Details </a><span
                        class="icon"></span>
                </div>
            </div>
            <a onclick="show_expecting()" href="javascript:;" style="margin-top: 30px;display: inline-block;font-size: 16px;color: #9d7cb3;float: right;">More></a>
        </div>

        <div class="build container">
            <h2><a onclick="show_expecting();" href="javascript:void(0);">Projects Updates</a></h2>
            <div class="content">
                <div class="right">
                    <div class="title">
                        <span><a style="text-decoration: none"
                                 onclick="show_expecting();" href="javascript:void(0);">{$lastmonth} {$lastmonth_notices[0].tags}</a></span>

                        <div class="more"><a onclick="show_expecting();" href="javascript:void(0);">More></a></div>
                    </div>
                    <div class="left">
                            ...
                            <span>
                                <!--<a href="/en/news/detail?id={$lastmonth_notices[0].notice_id}">-->
                                    ...
                                    <php>
                                        ...
                                        $string=$leng>20?substr($lastmonth_notices[0]['name'],
                                        0, 20,
                    ...
                    <div class="left last">
                        <!--<a href="/en/news/detail?id={$lastmonth_notices[1].notice_id}">-->
                            <a href="javascript:void(0);" class="aler">
                        ...
                        <div class="word">
                            <span>
                                 <!--<a href="/en/news/detail?id={$lastmonth_notices[1].notice_id}">-->
                                     <a href="javascript:void(0);" class="aler">
                                     <php>
                                         $leng=strlen($lastmonth_notices[1]['name'],'utf-8');
                                         $string=$leng>20?substr($lastmonth_notices[1]['name'], 0, 20,
                            ...
                            <p>
                                <php>
                                    $leng=strlen($lastmonth_notices[1]['desc'],'utf-8');
                                    $string=$leng>30?substr($lastmonth_notices[1]['desc'], 0, 30,
                ...
                <div class="left">
                    <div class="title">
                        <span><a style="text-decoration: none"
                                 onclick="show_expecting();" href="javascript:void(0);">{$thismonth} {$thismonth_notices[0].tags}</a></span>
                        <div class="more"><a onclick="show_expecting();" href="javascript:void(0);">More></a></div>
                    </div>
                    <div class="left">
                            ...
                            <span>
                                ...
                                <a href="javascript:void(0);" class="aler">
                                    <php>
                                        ...
                                        $string=$leng>20?substr($thismonth_notices[0]['name'], 0, 20,
                    ...
                    <div class="left last">
                        <!--<a href="/en/news/detail?id={$thismonth_notices[1].notice_id}">-->
                            <a href="javascript:void(0);" class="aler">
                        ...
                        <div class="word">
                            <span>
                                ...
                                <a href="javascript:void(0);" class="aler">
                                    <php>
                                        $leng=strlen($thismonth_notices[1]['name'],'utf-8');
                                        $string=$leng>20?substr($thismonth_notices[1]['name'], 0, 20,
                            ...
                            <p>
                                <php>
                                    $leng=strlen($thismonth_notices[1]['desc'],'utf-8');
                                    $string=$leng>30?substr($thismonth_notices[1]['desc'], 0, 30,
            ...
            <div class="content container">
                ...
                <div style="overflow: hidden;position: relative;">
                    ...
                    <div class="item">
                        ...
                        <span class="volume" id="val11"></span><span class="index">Million</span></div>
                    <div class="item">
                        <div class="title">Turnover</div>
                        $<span class="trunover" id="val12"></span><span class="index">Million</span></div>
                </div>
                ...
                <span class="time">
                        As as &nbsp;<span class="time-to" id="val07" style="padding-left: 4px;"></span>
                    </span>
                <p><span></span></p>
            </div>
            <div class="content1 container">
                <span class="text" style="float: right;color:#999;position: relative;z-index: 10">*Price will be delayed for15 minutes or more.
    ...
    <div class="modal fade" id="modal-old-web">
        <div class="modal-dialog modal-old-web" style="">
            <div class="old-web-btn-box " >                
                <a onclick="close_old_web();" style="margin-left:68px;cursor:pointer;"><img src="/public_en/img/home/index/go-new-btn.png" style=""></a>
                <a href="http://web.agile.com.cn/" style="margin-left:10px;"><img src="/public_en/img/home/index/go-old-btn.png" style=""></a>
            </div>
        </div>
    </div>
...
//            document.getElementById('val04').innerText = elements[5];
            document.getElementById('val06').innerText = 'Agile Group';
