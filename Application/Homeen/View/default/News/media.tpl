...
<block name="title">Media Reports-News Centre</block>
                    ...
                    <ul id="news-lists">
                        <volist name="notices" id="item" offset="0" length="12">
                            <li class="item">
                                ...
                                <h4 class="li-title" title=""><a href="/en/news/detail?id={$item.notice_id}" target='_blank'>{$item.name}</a>
                                </h4>
                                <div class="description">{$item.desc}</div>
                                <div class="more"><a href="/en/news/detail?id={$item.notice_id}" target='_blank'>Details <span class="icon"></span></a></div>
                            </li>
                        </volist>
