...
<block name="head_common1">
    <link rel="stylesheet" href="/public_en/css/home/enter/enter-publicity-vediodetail.css">
</block>
    ...
    <div class="section-s section1">
        <div class="content container">
            <p class="nav-p"><span><a href="/en/index">Home</a></span>&nbsp;&nbsp;&nbsp; > &nbsp;&nbsp;<span><a
                ...
                &nbsp;&nbsp;<a href="/en/enter/publicityvedio">Video</a></span>&nbsp;&nbsp; > &nbsp;&nbsp;<span>Details</span>
            </p>
...
<embed src="{$media.outside_link}" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" width="1000" height="134"></embed>
 ...
 -->
                ...
                <div class="tips">
                    ...
                    <span class="time">Length：{$media.duration}minutes</span>
                    <img src="/public_en/img/home/enter/publicity/detail_eye.png" alt=""
                         style="vertical-align: middle;margin-left: 20px">
                    <span style="margin-left: 30px;">Read：<span
                                style="color: #007069;font-size: 14px">{$media['view_count']}</span></span>
                    <a  style="margin-left: 30px;cursor:pointer;" id="a-two-code2"><img
                                    src="/public_en/img/home/enter/publicity/detail_icon1.jpg" alt=""></a>
                    <a onclick="shareXLWeiBo()" class="cursor"><span><img src="/public_en/img/home/enter/publicity/detail_icon2.jpg" alt=""></span></a>
                    <a onclick="shareQqZone()" class="cursor"><span><img src="/public_en/img/home/enter/publicity/detail_icon3.jpg" alt=""></span></a>
                </div>
    ...
    <div class="sections">
        <div class="section">
            <div class="content container">
                <h2 style="margin-top: 75px;margin-bottom: 30px;"><a href="/en/enter/publicityvedio">Videos</a></h2>
                <ul class="vedio-list">
                    <volist name="medias" id="item">
                        <li>
                            ...
                            Length: <span>{$item.duration}minute</span>
                        </li>
                    </volist>

                    <!--<li>-->
                    <!--<a href=""><img src="/public_en/img/home/enter/publicity/publicity_v4.jpg" alt="" style="width: 320px;height: 275px"></a>-->
