...
<block name="head_common1">
    <link rel="stylesheet" href="/public_en/css/home/enter/enter-history.css">
</block>
...
<block name="body_main">
    ...
    <div class="content container">
        <p><span><a href="/en/index">Home</a></span>&nbsp;&nbsp;&nbsp; > &nbsp;&nbsp;<span><a
            ...
            > &nbsp;&nbsp;<span>Milestones</span></p>
        <h2>Milestones</h2>
        <div>
            <span class="title">Group Milestones</span>
        </div>
        ...
        <div class="box">
            ...
            <a onclick="addTags()" class="pull" style="cursor: pointer"><img
                    src="/public_en/img/home/enter/history/history_pull.png"
                    alt=""></a>
        </div>
    </div>
</block>
        ...
        function addTags() {
            ...
            K.doAjax(data, window.document.location.href, function (res) {
                ...
                for (var i = 0; i < res.notice.length; i++) {
                    ...
                    li.append(span);
                    var circle = $('<span class="circle"><img src="/public_en/img/home/enter/history/history_circle.jpg" alt=""><img src="/public_en/img/home/enter/history/history_circle1.jpg" alt="" style="display: none"></span>');
